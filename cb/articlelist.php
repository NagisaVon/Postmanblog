...
<script type="text/javascript">
  ...
  function refreshList() {
    ...
    $.get("count_articles.php?album=-1user_id="+user_id+"&type="+type,function(data){article_num=data;});
    ...
    $('#article_List').load("DisplayArticles.php?&page=" + cur_page);
  }
  ...
  function LastNext() {
    article_num = 0;
    $.get("count_articles.php?album=-1&user_id="+user_id+"&type="+type,function(data){article_num=data;});
